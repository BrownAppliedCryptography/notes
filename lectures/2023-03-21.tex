...
\begin{definition}[Oblivious Transfer]
    ...
    % \Graphic{images/2023-03-21/ot.png}{0.8}
\end{definition}
...
\begin{example}[Private Dating/\textsf{AND} Gate]
    ...
    % \Graphic{images/2023-03-21/yao_private_dating.png}{0.8}
...
% \Graphic{images/2023-03-21/yao_multiple_gates.png}{0.8}
...
% \Graphic{images/2023-03-21/point_and_permute.png}{0.8}
