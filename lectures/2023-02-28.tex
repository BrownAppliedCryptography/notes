...
\todo{Watch first 5 mins of lecture to catch up on this part.}
...
% \Graphic{images/2023-02-28/sso.png}{0.8}
...
% \Graphic{images/2023-02-28/zkp.png}{0.8}

\begin{definition}[Zero-Knowledge Proof System]
    % \Graphic{images/2023-02-28/zkp_definition.png}{0.8}
...
\begin{example}[Diffie-Hellman Tuple]
    ...
    % \Graphic{images/2023-02-28/dh_tuple_proof.png}{0.8}
