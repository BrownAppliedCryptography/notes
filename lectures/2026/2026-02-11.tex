...
\label{20260211}
\subsection{More Block Cipher Modes of Operation}
...
\emph{How do we decrypt?} Since we know the first IV, we can compute the one-time pads $F_k(\mathrm{IV} + i)$ and $\mathsf{XOR}$ with $c_i$s. This scheme is valid.
