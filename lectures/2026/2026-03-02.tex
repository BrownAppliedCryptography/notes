%!TEX root = ../notes.tex
\section{March 2, 2026}
\label{20260302}

This lecture we will continue our discussion on zero-knowledge proofs, and give an example of a zero-knowledge proof for the Diffie-Hellman tuple. We will also discuss non-interactive zero-knowledge proofs and the Fiat-Shamir heuristic.
...
\subsection{Fiat-Shamir Heuristic}\label{sec:mar7-fiat-shamir}
