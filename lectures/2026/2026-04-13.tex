%!TEX root = ../notes.tex
\section{April 13, 2026}
\label{20260413}

In this lecture, we will continue discussing Fully Homomorphic Encryption. We want to use more solid assumptions, so we introduce a new assumption called Learning with Errors, which is a post-quantum assumption, i.e. it is secure against known quantum attacks.
