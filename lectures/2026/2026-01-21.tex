...
The course homepage is at \url{https://cs.brown.edu/courses/csci1515/spring-2026/}, where you can find information such as the \href{https://docs.google.com/document/d/1v0KsS8-qRRB7FoG-mM76rW4d9YS88_P97RvxtKRMhq0}{syllabus}, projects, homeworks, calendar, lectures and more.

The course is offered in-person in \emph{Friedman 108}, as well as synchronously over Zoom and recorded asynchronously (lectures posted online). Lecture attendance and participation is highly encouraged!
...
\begin{center}
    \begin{tabular}{@{}ll@{}}
        ...
        Homeworks               & 25\% (5\% each)     \\
        Final Project           & 14\%                \\ \bottomrule
    \end{tabular}
\end{center}

You have a total of four (4) late days that you can use to extend the due dates of \emph{Projects 0–5} free of charge, but at most two (2) late days may be applied to any one project. Beyond that, you will be penalized 40\% of the project’s value for each day it is late. There are \textbf{no} late days for \emph{homeworks}, as we want to release the solution guide as soon as possible.
...
\begin{definition}[Public-key Encryption]
    There is another primitive that is much stronger: \ul{public-key encryption}. Bob generates both a \emph{public} key and a \emph{private} key, and then publishes his public key. You can consider a lock where you don't need a key to lock it\framedfootnote{You literally click it closed}, and only Bob has the key to unlock it.
...
\begin{enumerate}
    ...
    \item \emph{PIR} Private Information Retrieval (using homomorphic encryption, a form of post-quantum cryptography).
\end{enumerate}
...
\begin{itemize}
    ...
    \item \emph{What is the difference between CSCI 1515 and CSCI 1510, MATH 1580, or CSCI 1040?}
...
This course \textbf{will not} be offered in Spring 2027.
